...
namespace MobiStore.MySQL
{
    public partial class MobiStore.MySQLContext : OpenAccessContext
    {
        static MetadataContainer metadataContainer = new MobiStore.MySQLMetadataSource().GetModel();
